...
use ethers_core::types::{
    ...
    NameOrAddress, Transaction, TransactionReceipt, TxHash, U256, TxpoolTransaction,
};
use std::sync::Arc;
use thiserror::Error;
    ...
    M: Middleware,
{
    ...
    async fn subscribe_pending_txs(
        &self,
    ) -> Result<ethers_providers::SubscriptionStream<'_, Self::Provider, TxpoolTransaction>, Self::Error>
    where
        Self::Provider: ethers_providers::PubsubClient,
    {
        Err(TimeLagError::Unsupported)
